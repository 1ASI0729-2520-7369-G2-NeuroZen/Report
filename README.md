...
![swagger_apoint.png](imgs/swagger_apoint.png)
...
| **Sprint Goal & User Stories**      | —                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Sprint 4 Goal**                   | Implementar el bounded context IAM en el backend, integrar completamente el frontend Angular con el backend desplegado en Render, estabilizar la experiencia del usuario y cerrar la documentación final del proyecto (entrevistas de validación, heurísticas, video del producto, conclusiones, bibliografía y anexos)                                 |
| **Sprint 4 Velocity**               | 8                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| Autor                           | Fecha      | Commit Message                                                                                     | Commit ID |
| :------------------------------ | :--------- | :------------------------------------------------------------------------------------------------- | :-------- |
| Fernandez Alexander Piero       | 10/11/2025 | feat(iam): add authentication endpoints and JWT token generation                                   | s5g875s   |
| Ian Nawrocki Loureiro           | 12/11/2025 | feat(iam): implement user registration and password recovery                                       | q58sg8s   |
